...
export function UserCreateForm() {
  ...
  const [validationErrors, setValidationErrors] = useState<Partial<CreateUserFormData>>({});
    ...
    <div className="max-w-md mx-auto">
      <Card>
        <CardHeader className="flex flex-col items-start px-4 py-4">
          ...
          <p className="text-sm text-gray-500">Add a new user account with role assignment</p>
        </CardHeader>
